...
namespace Conv.ORM.Connections.Classes.CommandBuilders.SqlServer
{
    class SqlServerCommandUpdateBuilder : ICommandUpdateBuilder
    {
        private readonly ModelEntity _modelEntity;
        private readonly QueryConditionsBuilder _queryConditionsBuilder;

        public SqlServerCommandUpdateBuilder(ModelEntity model, QueryConditionsBuilder queryConditionsBuilder)
        {
            _modelEntity = model;
